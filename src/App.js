...
import SingleDeptHeadCard from './Components/dashboard/DeptHead/SingleDeptHeadCard';
  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route path='/dashboard/deptHeadUpdate/:id' element={<DeptHeadUpdate />} />
        <Route path="/dashboard/deptHead/:id" component={<SingleDeptHeadCard/>} />
